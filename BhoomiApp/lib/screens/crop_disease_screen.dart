      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const Text(
              'Upload your crop photo to identify diseases and receive tailored solutions instantly.',
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final statusColor =
                      scan['status'] == 'Healthy' ? Colors.green : Colors.red; 
